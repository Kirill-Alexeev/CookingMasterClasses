...
class KaexamSerializer(serializers.ModelSerializer):
...
class ExamListView(generics.ListAPIView):
    queryset = kaexam.objects.filter(is_public=True)
    serializer_class = KaexamSerializer
    permission_classes = [AllowAny]
